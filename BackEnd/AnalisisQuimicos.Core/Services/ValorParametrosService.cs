...
{
    public class ValorParametrosService : IValorParametrosService //IRepository<ValorParametros>
    {
        ...
        {
            return _unidadDeTrabajo.ValorParametrosRepository.GetParameters(filtro);
        }
    }
}
